...
module.exports.getCatalogList = (app) => {
  return {
    docs: {
      find: {
        summary: app.utils.docs.translate.default('Get Catalog Relationship List'),
        description: app.utils.docs.translate.default('Get Catalog Relationship List'),
        parameters: [
          {
...
module.exports.getCatalog = (app) => {
  return {
    docs: {
      find: {
        summary: app.utils.docs.translate.default('Get Catalog Relationship'),
        description: app.utils.docs.translate.default('Get Catalog Relationship'),
        parameters: [
          {
...
module.exports.saveCatalog = (app) => {
  return {
    docs: {
      create: {
        summary: app.utils.docs.translate.default('Save Catalog Relationship'),
        description: app.utils.docs.translate.default('Save Catalog Relationship'),
        parameters: [
          {
            description: app.utils.docs.translate.property('Catalog Relationship'),
            in: 'body',
            name: 'body',
            required: true,
            schema: {
...
module.exports.updateCatalog = (app) => {
  return {
    docs: {
      create: {
        summary: app.utils.docs.translate.default('Update Catalog Relationship'),
        description: app.utils.docs.translate.default('Update Catalog Relationship'),
        parameters: [
          {
            description: app.utils.docs.translate.property('Catalog Relationship'),
            in: 'body',
...
module.exports.removeCatalog = (app) => {
  return {
    docs: {
      create: {
        summary: app.utils.docs.translate.default('Remove Catalog Relationship'),
        description: app.utils.docs.translate.default('Remove Catalog Relationship'),
        parameters: [
          {
            description: app.utils.docs.translate.property('Catalog Relationship'),
            in: 'body',
